...
/** Input to create a Comment for the CommentRelatePost relation of Post */
export type PostCommentRelatePostCommentCreateInput = {
  message: Scalars['String'];
  published?: InputMaybe<Scalars['Boolean']>;
};

/** Input to link to or create a Comment for the CommentRelatePost relation of Post */
...
/** Input to link/unlink to or create a Comment for the CommentRelatePost relation of Post */
...
export type GetAllPostsQuery = { __typename?: 'Query', postCollection?: { __typename?: 'PostConnection', edges?: Array<{ __typename?: 'PostEdge', node: { __typename?: 'Post', id: string, title: string, slug: string, likes?: number | null } } | null> | null } | null };
...
export type GetPostBySlugQuery = { __typename?: 'Query', post?: { __typename?: 'Post', id: string, title: string, slug: string, likes?: number | null } | null };

export type IncrementPostLikesByIdMutationVariables = Exact<{
  id: Scalars['ID'];
}>;


export type IncrementPostLikesByIdMutation = { __typename?: 'Mutation', postUpdate?: { __typename?: 'PostUpdatePayload', post?: { __typename?: 'Post', id: string, likes?: number | null } | null } | null };
...
export const IncrementPostLikesByIdDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"IncrementPostLikesById"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"postUpdate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"by"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"likes"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"increment"},"value":{"kind":"IntValue","value":"1"}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"post"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"likes"}}]}}]}}]}}]} as unknown as DocumentNode<IncrementPostLikesByIdMutation, IncrementPostLikesByIdMutationVariables>;